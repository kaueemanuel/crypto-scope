...
export class GetCoinsParamsDto {
  @ApiPropertyOptional({
  ...
  order_by?: 'market_cap_asc' | 'market_cap_desc' | 'volume_asc' | 'volume_desc' | 'id_asc' | 'id_desc' = 'market_cap_desc';
}

export const GetCoinsResponseDto = createPaginatedResponseDto(CoinDto);

export type GetCoinsResponseDtoType = InstanceType<typeof GetCoinsResponseDto>;
